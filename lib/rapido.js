...
exports.create = function() {
    ...
    var rapido = {
        ...
        doRun: function(args) {
            ...
            enabledStacks = enabledStacks.concat(rapido.additionalEnabledStacks);
            enabledStacks.push('default'); // Always enable the default stack
            ...
            if (!matchingCommands.length) {
                rapido.log.error('Command not found: ' + commandParts.join(' '));
                return;
            }
